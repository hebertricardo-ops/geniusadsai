...
serve(async (req) => {
  ...
  try {
    ...
    const vertexEndpoint = `https://global-aiplatform.googleapis.com/v1/projects/${saJson.project_id}/locations/global/publishers/google/models/gemini-3-pro-image-preview:generateContent`;
