...
serve(async (req) => {
  ...
  try {
    ...
    const vertexEndpoint = `https://us-central1-aiplatform.googleapis.com/v1/projects/${saJson.project_id}/locations/us-central1/publishers/google/models/gemini-3-pro-image-preview:generateContent`;
